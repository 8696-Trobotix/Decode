 ...
 * measurements. Based on WPILib's {@code PoseEstimator} class.
 *
 * <p>{@link PinpointPoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link PinpointPoseEstimator#addVisionMeasurement} can be called as infrequently as you want;
 * if you never call it then this class will behave exactly like regular encoder odometry.
 */
public class PinpointPoseEstimator {
  private final Pinpoint m_odometry;
  ...
  /**
   * Constructs a PinpointPoseEstimator.
   *
   * @param pinpoint The {@link Pinpoint} to be used as the odometry source.
  ...
  public PinpointPoseEstimator(
      Pinpoint pinpoint, Matrix<N3, N1> stateStdDevs, Matrix<N3, N1> visionMeasurementStdDevs) {
    this.m_odometry = pinpoint;
   ...
   * PinpointPoseEstimator#update} every loop.
   *
   ...
   * PinpointPoseEstimator#setVisionMeasurementStdDevs(Matrix)} or this method.
   *
   * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
   * @param timestampSeconds The timestamp of the vision measurement in seconds.
   * @param visionMeasurementStdDevs Standard deviations of the vision pose measurement (x position
