...
public class CommandXboxController {
   ...
   *
   * @param gamepadSupplier A supplier providing the {@link Gamepad} to use.
   */
  public CommandXboxController(Supplier<Gamepad> gamepadSupplier) {
    this.gamepadSupplier = gamepadSupplier;
  }
